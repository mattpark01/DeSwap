const serverUrl = "https://ri4mm5a39b2k.usemoralis.com:2053/server"; //Server url from moralis.io
const appId = "jSVXAEhezgKMRX6H6lg0iaKhQ3NctfupOY0pvMVm"; // Application id from moralis.io
let currentTrade = {};
